...
def gen_qrecc_qrel(input_test_file, output_qrel_file, pid2rawpid_path):
    ...
    rawpid2pid = {}
    for pid, rawpid in list(pid2rawpid.items()):
...
if __name__ == "__main__":
    # input_passage_dir = "collection-paragraph"
    input_passage_dir = "datasets/ml-qrecc/passages/collection-paragraph"
    ...
    train_inputfile = "datasets/ml-qrecc/scai-qrecc21-training-turns.json"
    test_inputfile = "datasets/ml-qrecc/scai-qrecc21-test-turns.json"
    ...
    input_test_file = "datasets/ml-qrecc/scai-qrecc21-test-turns.json"
    pid2rawpid_path = "new_preprocessed/pid2rawpid.pkl"
    output_qrel_file = "new_preprocessed/qrecc_qrel.tsv"
    # gen_qrecc_qrel(input_test_file, output_qrel_file, pid2rawpid_path)
    
    qrecc_collection_path = "new_preprocessed/qrecc_collection.tsv"
    ...
    train_inputfile = "new_preprocessed/train.json"
    train_outputfile_with_doc = "new_preprocessed/train_with_bm25_hard_neg.json"
